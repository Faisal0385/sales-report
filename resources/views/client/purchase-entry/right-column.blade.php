<div class="lg:col-span-1 space-y-6">
    ...
    <div class="bg-gray-800 p-6 rounded-lg border border-gray-700">
        <h3 class="font-semibold text-gray-300">View Monthly Report</h3>
        <hr>
        <form action="{{ route('purchases.month.view') }}" method="POST">
            @csrf
    ...
    <div class="bg-gray-800 p-6 rounded-lg border border-gray-700">
        <h3 class="font-semibold text-gray-300">View Yearly Report</h3>
        <hr>
        <form action="{{ route('purchases.year.view') }}" method="POST">
            @csrf
