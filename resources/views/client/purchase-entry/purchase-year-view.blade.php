            ...
            <div class="p-6 bg-gray-800 rounded-b-lg">
                ...
                <div class="mt-3">
                    ...
                    <div class="bg-gray-900 p-6 rounded-lg border border-gray-700">
                        <h2 class="text-lg font-semibold">Year {{ $year }}</h2>
                            ...
                            <table class="min-w-full text-sm text-left">
                                ...
                                <tbody id="sales-entries-tbody">
                                    ...
                                    @forelse($sales as $key => $sale)
                                        <tr>
                                            <td class="py-3 px-3">{{ $monthOrder[$sale->month] ?? null }}</td>
                                            <td class="py-3 px-3">{{ $sale->total ?? null }}</td>
                                        </tr>
                                    @empty
                                        <tr>
                ...
                <br>
                <form action="{{ route('purchases.report.download') }}" method="GET">
