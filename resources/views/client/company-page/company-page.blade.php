...
<body class="bg-gray-900 text-white flex items-center justify-center min-h-screen">
    ...
    <div class="w-full max-w-5xl p-4">
        ...
        <!-- =================================== -->
        <!--  1. Select Company Page            -->
        <!-- =================================== -->
        <div id="page-select-company" class="page space-y-8 text-center max-w-md mx-auto">
            <div>
                <h1 class="text-3xl font-bold">Select Your Company</h1>
                <p class="text-gray-400 mt-2">Choose the company you want to log in to.</p>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <!-- TechPoint Company Card -->
                <div onclick="selectCompany('TechPoint')"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-purple-400 mx-auto" fill="none"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M12 6V5m0 14v-1M9 6l1.293-1.293a1 1 0 011.414 0L12 6m0 12l1.293 1.293a1 1 0 001.414 0L15 18M9.75 12h4.5M12 9.75v4.5" />
                    </svg>
                    <h3 class="font-semibold mt-4">TechPoint</h3>
                </div>
                <!-- TikTech Company Card -->
                <a href="./02-branch.html"
                    class="bg-gray-800 p-6 rounded-lg border border-gray-700 hover:bg-gray-700 hover:border-purple-500 cursor-pointer transition-all duration-300">
                    <!-- Icon: Phone -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-purple-400 mx-auto" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                    ...
                    <h3 class="font-semibold mt-4">TikTech</h3>
                </a>
                <!-- Restaurant Company Card -->
                <div onclick="selectCompany('Restaurant')"
                    class="bg-gray-800 p-6 rounded-lg border border-gray-700 hover:bg-gray-700 hover:border-purple-500 cursor-pointer transition-all duration-300">
                    <!-- Icon: Utensils -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-purple-400 mx-auto" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M15.362 5.214C16.317 4.209 17.587 3 19.5 3c2.21 0 4 1.79 4 4 0 1.913-.91 3.56-2.35 4.638M12 12.75h9" />
                    </svg>
                    <h3 class="font-semibold mt-4">Restaurant</h3>
                </div>
            </div>
        </div>
